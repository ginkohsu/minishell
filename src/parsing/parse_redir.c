...
/*   Updated: 2025/11/19 20:26:07 by jinxu            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char	*process_filename(t_parser *parser, t_token *redir_token,
		t_token *filename_token, int *quoted)
{
	char	*filename;
...
int	parse_redirection(t_parser *parser, t_command *cmd)
{
	...
	filename = process_filename(parser, redir_token, filename_token, &quoted);
